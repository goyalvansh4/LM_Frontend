      ...
      <div className="w-full max-w-4xl bg-white dark:bg-gray-900 shadow-lg rounded-lg p-8 transition-transform duration-500 ease-in-out transform hover:-translate-y-1">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5 mt-6">
            <button
              type="submit"
              className="justify-center py-3 px-6 text-white bg-blue-600 hover:bg-blue-500 text-lg rounded-lg font-semibold shadow-md flex items-center dark:bg-blue-500 dark:hover:bg-blue-400"
              disabled={loading}
            >
