    ...
    <>
      <div className="mt-4">
        <div className="flex flex-wrap items-center">
          <div className="w-full px-4 sm:w-2/4 xl:w-1/4">
            <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-md shadow-slate-200">
              ...
              <div className="mx-5">
                <h4 className="text-2xl font-semibold text-gray-700">
                  {leadStat.reduce((acc, category) => {
                    return acc + category.leads_count;
                  }, 0)}
                </h4>
          ...
          {leadStat.map((category, index) => {
            const IconComponent = icons[index % 3].component;
            return (
              <div
                key={category.id}
                className="w-full px-4 my-2 sm:w-2/4 xl:w-1/4"
              >
                <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-md shadow-slate-200">
                  <div
