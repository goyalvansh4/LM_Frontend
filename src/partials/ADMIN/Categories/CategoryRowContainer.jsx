...
import CategoriesData from "./CategoryData/CategoriesData";
...
const CategoryRowContainer = () => {
  ...
  //   const allChecked = leadData.every((category) => category.checked);
  ...
  const toggleSelectAll = () => {
    const updatedData = leadData.map((category) => ({
      ...category,
        ...
        <>
          <table className="min-w-full dark:bg-gray-900">
            ...
            <tbody className="bg-white dark:bg-gray-900">
              {leadData.map((category, index) => (
                <tr
                  key={category.id}
                  className={`dark:bg-gray-800 ${
                    category.assign_to_name === "-"
                      ? "bg-blue-100 dark:bg-[#323545]"
                      : "bg-white"
                  }`}
                >
                  ...
                  <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-700">
                    <NavLink
                      to={`/admin/leads/showDetails/${category.id}`}
