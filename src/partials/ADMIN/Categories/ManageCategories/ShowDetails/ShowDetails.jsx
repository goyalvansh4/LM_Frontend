...
const ShowDetails = () => {
  const { id } = useParams();
  const [category, setLead] = useState({
    register_number: "",
    rto_location_name: "",
    register_date: "",
    customer_name: "",
  ...
  const saveRemark = async () => {
    ...
    try {
      ...
      if (response.data.status === "success") {
        setLead({ ...category, remarks: remarkText });
  ...
  const handleDateClick = async () => {
    ...
    try {
      ...
      if (response.data.status === "success") {
        setLead({ ...category, due_date: date });
  ...
  return (
    <div className="w-full h-full p-10 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p
              className={`text-lg ${
                category.status_name.toLowerCase() === "active"
                  ? "text-green-600"
                  : "text-red-600"
              } uppercase`}
            >
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p
              className={`text-lg ${
                !category.assign_to_name
                  ? "text-red-600"
                  : "text-gray-800 dark:text-gray-100"
              }`}
            >
              {category.assign_to_name || "Not Assigned"}
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-xs font-medium text-gray-600 dark:text-gray-400">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-lg text-gray-800 dark:text-gray-100">
              {category.due_date
                ? moment(category.due_date).format("D - MMMM - YYYY")
                : "Not Set"}
            </p>
          </div>
          <div className="flex flex-col gap-2">
      ...
      <div className="relative p-6 border border-gray-300">
        <div className="relative">
          ...
          <p className="pl-8 text-base text-gray-800 dark:text-gray-100 mb-4">
            {category.remarks || "No Remarks Yet..."}
          </p>
        </div>
      </div>
      ...
      <button
        ...
        onClick={openModal}
      >
        {category.remarks ? "Change Remark" : "Add Remark"}
      </button>
