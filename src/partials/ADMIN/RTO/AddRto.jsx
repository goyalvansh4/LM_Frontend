...
const AddRto = () => {
  ...
  useEffect(() => {
    // Fetch states and RTO locations from API
  ...
  return (
    <div className="flex flex-col p-6">
      ...
      <button
        ...
        } rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50`}
      >
        {editMode ? "Update" : "Add"}
      </button>
      ...
      <table className="min-w-full mt-8 bg-white border border-gray-200 rounded-lg">
        <thead>
          <tr className="bg-gray-100">
            <th className="px-6 py-3 border-b border-gray-200">S.NO</th>
            <th className="px-6 py-3 border-b border-gray-200">Name</th>
            <th className="px-6 py-3 border-b border-gray-200">State Name</th>
            ...
            <tr key={rtoLocation.id} className="hover:bg-gray-100">
              ...
              <td className="px-6 py-4 border-b border-gray-200">
                <button
                  ...
                  className="px-4 py-2 mr-2 text-white bg-yellow-500 rounded-lg hover:bg-yellow-600 focus:outline-none"
                >
                  Edit
                </button>
                <button
